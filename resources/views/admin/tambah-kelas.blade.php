				...
				<div class="table-responsive">
					<table id="example" class="table table-bordered">
						...
						<tbody>
							...
							<th>{{$data->major}}</th>
							<th><button class="btn btn-danger m-1" data-toggle="modal" data-target="#edit{{$data->id_class}}">Edit</button></th>
							<th><a href="" class="btn btn-success" btn-sm >DELETE</th>
									...
									<div class="modal-body">
										<form method="post" action="{{URL::to('/admin/update/class',$data->id_class)}}">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control valid" id="input-6" name="class_name" required="" aria-invalid="false" value="{{$data->class_name}}">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control valid" id="input-6" name="major" required="" aria-invalid="false" value="{{$data->major}}">
