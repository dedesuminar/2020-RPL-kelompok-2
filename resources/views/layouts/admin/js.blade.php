 <script src="{{ URL::to('assets/js/jquery.min.js')}}"></script>
  ...
  <script src="{{ URL::to('assets/plugins/vertical-timeline/js/vertical-timeline.js') }}"></script>
  ...
  <script src="{{Url::to('assets/plugins/switchery/js/switchery.min.js')}}"></script>
  ...
  @yield('js')
    ...
    <script>
        $(document).ready(function() {
         ...
         $('#province').on('change', function(e){
             ...
             $.get('{{URL::to('api/json-city')}}/' + province_id , function(data){
                 console.log(data);
                 $('#city').empty();
                 $('#city').append('<option value=""> Pilih Kota</option>');


                 $.each(data.city, function(val, cityObj){
         ...
         $('#city').on('change', function(e){
            ...
            $.get('{{URL::to('api/json-district')}}/' + city_id , function(data){
                console.log(data);
                $('#district').empty();
                $('#district').append('<option value=""> Pilih Kecamatan</option>');


                $.each(data.district, function(val, districtObj){
         ...
         $('#district').on('change', function(e){
            ...
            $.get('{{URL::to('api/json-village')}}/' + district_id , function(data){
                console.log(data);
                $('#village').empty();
                $('#village').append('<option value=""> Pilih Kelurahan</option>');


                $.each(data.village, function(val, villageObj){
                    $('#village').append('<option value="'+ villageObj.id +'">'+ villageObj.village_name +'</option>');
                });
            });
        });
    ...
    <script>
        $('#dom_province').on('change', function(e){
                             console.log(e);
                             var dom_province_id = e.target.value;
                             $.get('{{URL::to('api/dom_json-city')}}/' + dom_province_id , function(data){
                                 console.log(data);
                                 $('#dom_city').empty();
                                 $('#dom_city').append('<option value=""> Pilih Kota</option>');


                                 $.each(data._dom_city, function(val, dom_cityObj){
                                     $('#dom_city').append('<option value="'+ dom_cityObj.id +'">'+ dom_cityObj.city_name +'</option>');
                                 });
                             });
                         });


                         $('#dom_city').on('change', function(e){
                            console.log(e);
                            var dom_city_id = e.target.value;
                            $.get('{{URL::to('api/dom_json-district')}}/' + dom_city_id , function(data){
                                console.log(data);
                                $('#dom_district').empty();
                                $('#dom_district').append('<option value=""> Pilih Kecamatan</option>');


                                $.each(data.dom_district, function(val, dom_districtObj){
                                    $('#dom_district').append('<option value="'+ dom_districtObj.id +'">'+ dom_districtObj.district_name +'</option>');
                                });
                            });
                        });


                         $('#dom_district').on('change', function(e){
                            console.log(e);
                            var dom_district_id = e.target.value;
                            $.get('{{URL::to('api/dom_json-village')}}/' + dom_district_id , function(data){
                                console.log(data);
                                $('#dom_village').empty();
                                $('#dom_village').append('<option value=""> Pilih Kelurahan</option>');


                                $.each(data.village, function(val, villageObj){
                                    $('#dom_village').append('<option value="'+ dom_villageObj.id +'">'+ dom_villageObj.village_name +'</option>');
                                });
                            });
                        });
    </script>
